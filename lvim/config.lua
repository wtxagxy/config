...
lvim.keys.visual_mode["<lt>D-s>"] = "<cmd>w!<CR>"
lvim.keys.normal_mode["<lt>D-/>"] = "<Plug>(comment_toggle_linewise_current)"
lvim.keys.visual_mode["<lt>D-/>"] = "<Plug>(comment_toggle_linewise_visual)"
...
lvim.keys.insert_mode["<c-h>"] = "<backspace>"
lvim.keys.insert_mode["<c-f>"] = "<right>"
lvim.keys.insert_mode["<c-b>"] = "<left>"
lvim.keys.insert_mode["<c-k>"] = "<esc>lDa"
lvim.keys.insert_mode["<c-u>"] = "<home>"
lvim.keys.insert_mode["<c-p>"] = "<up>"
lvim.keys.insert_mode["<c-n>"] = "<down>"

-- command emacs key
lvim.keys.command_mode["<c-a>"] = {"<home>",      {noremap = false}}
lvim.keys.command_mode["<c-e>"] = {"<end>",       {noremap = false}}
lvim.keys.command_mode["<c-d>"] = {"<del>",       {noremap = false}}
...
-- 识别文件 *.lua.txt = lua 
autocmd({'BufNewFile', 'BufRead'}, {desc = '*.lua.txt is lua', pattern = "*.lua.txt",command = "setf lua"})
